    ...
    private void showOption(String option) {
        ...
        try{
            if (option.equals("Call Center")){
                String CallCenter = "tel: 07616989999";
                ...
                x.setData(Uri.parse("sms:07616989999"));
                x.putExtra("sms_body",word);

            }else if(option.equals("Direction")){
                String lokasi = "google.navigation:q=0.530660, 101.436039";
                ...
                x.putExtra(SearchManager.QUERY,"Rumah Sakit Eka Hospital Pekanbaru");
