    ...
    private void showOption(String option) {
        ...
        try{
            if (option.equals("Call Center")){
                String CallCenter = "tel: +6276121657";
                ...
                x.setData(Uri.parse("sms:+6276121657"));
                x.putExtra("sms_body",word);

            }else if(option.equals("Direction")){
                String lokasi = "google.navigation:q=0.523085, 101.452209";
                ...
                x.putExtra(SearchManager.QUERY,"Rumah Sakit Umum Daerah Arifin Achmad Pekanbaru");
