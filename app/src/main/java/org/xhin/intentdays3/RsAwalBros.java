    ...
    private void showOption(String option) {
        ...
        try{
            if (option.equals("Call Center")){
                String CallCenter = "tel: +6276147333";
                ...
                x.setData(Uri.parse("sms:+6276147333"));
                x.putExtra("sms_body",word);

            }else if(option.equals("Direction")){
                String lokasi = "google.navigation:q=0.500659, 101.454014";
                ...
                x.putExtra(SearchManager.QUERY,"Rumah Sakit awal Bros Pekanbaru");
